  ...
  usuario.avatar.deck.forEach(card => {
    cardsHTML += `
      ...
      <div class="card-details">
        ...
        <p><strong>Efeito:</strong> ${card.tipoEfeito}</p>
      </div>
    </div>
  `;
});
...
const baseUrl = "http://localhost:9090/api/usuarios";
...
async function carregarUsuario() {
  ...
  document.getElementById('moedas-temporarias').textContent = usuario.avatar.progressao.totalMoedasTemporarias;
  document.getElementById('total-cliques').textContent = usuario.avatar.progressao.totalCliques;
  document.getElementById('inimigos-derrotados').textContent = usuario.avatar.progressao.totalInimigosDerrotados;
  document.getElementById('moeda-permanente').textContent = usuario.moedaPermanente.quantidade;
  document.getElementById('user-deck').textContent = usuario.avatar.deck;
}
